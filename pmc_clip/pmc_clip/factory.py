...
def load_state_dict(checkpoint_path: str, map_location='cpu', mode=None):
    ...
    if mode == "lora":
        ...
        state_dict["module.lora_text_projection"] = _state_dict["module.text_projection"].T
    else:
        state_dict = _state_dict
...
def load_checkpoint(model, checkpoint_path, strict=True, mode=None):
    state_dict = load_state_dict(checkpoint_path, mode=mode)
